...
app.controller('CandidateData', function ($scope, $http) {
    ...
    $scope.GetDailyReports = function () {
        ...
        $http.get("/AssessmentReport/GetCandidateCountBatchList?Training_Type=" + $scope.Training_Type + "&Training_Date=" + Training_date).then(function (d) {
            console.log(d);
...
//Export the data in excel for batch end by services and mobile app
    ...
    $scope.ExportDailyReport1 = function () {
        ...
        vhtml = vhtml + '<th style="background-color:#c3dde0;border-width: 1px;padding: 8px;border-style: solid;border-color: #a9c6c9;">Total Candidate</th>';
        vhtml = vhtml + '<th style="background-color:#c3dde0;border-width: 1px;padding: 8px;border-style: solid;border-color: #a9c6c9;">Total Present</th>';
        vhtml = vhtml + '<th style="background-color:#c3dde0;border-width: 1px;padding: 8px;border-style: solid;border-color: #a9c6c9;">Total AuthAadhaar</th>';
        vhtml = vhtml + '<th style="background-color:#c3dde0;border-width: 1px;padding: 8px;border-style: solid;border-color: #a9c6c9;">Total Manually</th>';
        ...
        angular.forEach($scope.GetDailyReportsList1, function (value, index) {
            ...
            vhtml = vhtml + '  <td style="border-width: 1px;padding: 8px;border-style: solid;border-color: #a9c6c9;">' + value.TotalCandidate + '</td> ';
            vhtml = vhtml + '  <td style="border-width: 1px;padding: 8px;border-style: solid;border-color: #a9c6c9;">' + value.TotalPresent + '</td> ';
            vhtml = vhtml + '  <td style="border-width: 1px;padding: 8px;border-style: solid;border-color: #a9c6c9;">' + value.TotalAuthAadhaar + '</td> ';
            vhtml = vhtml + '  <td style="border-width: 1px;padding: 8px;border-style: solid;border-color: #a9c6c9;">' + value.TotalManually + '</td> ';
            vhtml = vhtml + ' </tr>';
        });
        ...
        saveAs(blob, "CandidateCountwisebatchList.xls");
    };
});
