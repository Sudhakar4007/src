		...
		function _fnBuildAjax(oSettings, data, fn) {
			...
			var baseAjax = {
				...
				"success": function (json) {
					var obj12 = json;
					json.data = obj12.lst;
					json.recordsTotal = obj12.TotalRecords;
					json.recordsFiltered = obj12.FilterRecords;
					json.draw = obj12.FilterAction.toString();

					delete obj12.lst;
					delete obj12.TotalRecords;
					delete obj12.FilterRecords;
					delete obj12.FilterAction;
	 ...
	 */
		...
		DataTable.defaults = {
			...
			"oLanguage": {
				 ...
				 *    } );
				 */
				"sProcessing": '<div class="loaderContainer"><div id="loading-bar-spinner"><div class="spinner-icon"></div></div></div>',
