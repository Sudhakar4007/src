          ...
          ctrl.createEditor = function(froalaInitOptions) {
            ...
            if (!ctrl.editorInitialized) {
              ...
              ctrl.options = angular.extend({
                  imageUploadURL: '/FileManager/UploadImage',
                  fileUploadURL: '/FileManager/UploadFile',
                  imageManagerLoadURL: '/FileManager/LoadImages',
                  imageManagerDeleteURL: "/FileManager/DeleteImage",
                  imageManagerDeleteMethod: "POST"

              }, defaultConfig, froalaConfig, scope.froalaOptions, froalaInitOptions);

              ctrl.registerEventsWithCallbacks('froalaEditor.initializationDelayed', function() {
                ngModel.$render()
              });

              ctrl.registerEventsWithCallbacks('froalaEditor.initialized', function (e, editor) {
